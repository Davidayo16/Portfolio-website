                  ...
                  <div className=" about-item ">
                    ...
                    <div className="about-item-bottom">
                      ...
                      <p className="mt-3 bold ">
                        ...
                        and intuitive websites that seamlessly blend
                        cutting-edge design with robust functionality, ensuring
                        an exceptional user experience. My passion for web
                        development drives me to deliver impactful solutions
                        that exceed client expectations and elevate online
                        presence.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="about-item">
                    ...
                    <div className="about-item-bottom">
                      ...
                      <p className="mt-3 bold">
                        ...
                        JavaScript, I create visually appealing and responsive
                        web interfaces that captivate users and enhance their
                  ...
                  <div className="about-item">
                    ...
                    <div className="about-item-bottom">
                      ...
                      <p className="mt-3 bold ">
                        ...
                        Leveraging my skills in languages such as Python,
                        Node.js, and databases like MySQL and MongoDB, I develop
                        efficient server-side logic, APIs, and database
                        integrations, ensuring seamless functionality and
                        optimal performance.
                      </p>
                    </div>
                  </div>
