    ...
    _roundStars: function(score, evt) {
      ...
      if (name) {
        var
          ...
          star = this.stars[Math.ceil(score) - 1]; // Fixbug
    ...
    _setTitle: function(score, evt) {
      if (score) {
        var
          ...
          star = this.stars[Math.max( integer - 1,0)] // Fixbug
    ...
    var readonly = $(this).data('readonly');
	  $(this).raty({
        score: 5,
		    readOnly: readonly,
        half: true,
        showStarTitle: noo_rating.showStarTitle === 'yes'  ? true : false
	  });
  });
})(jQuery);
